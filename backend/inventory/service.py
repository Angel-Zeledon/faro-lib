...
def build_explanation(
    ...
    coverage = (
        f"te alcanza para {coverage_days:.0f} días"
    ...
    base = (
        ...
        f"así que {coverage}. Como {lt_phrase}, deberías volver a pedir cuando "
    ...
    for item in items:
        ...
        if signal == 'PEDIR_YA' and days is not None:
            recs.append({
                ...
                'text': (
                    f"Emite la orden de {name} HOY — tienes {days:.0f} días de stock "
